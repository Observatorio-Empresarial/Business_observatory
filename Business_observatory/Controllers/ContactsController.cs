...
namespace Business_observatory.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Surname,Email,Phone,Message,Status")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Surname,Email,Phone,Message,Status")] Contact contact)
        {
            if (id != contact.Id)
            {
                return NotFound();
